...
static struct skill_i
{
	...
	{{"Buerocracy", "Бюрократия"}, {0, 0, 0, 0, 0}},
	{{"Galactic Lore", "Знание галактики"}, {0, 0, 0, 0, 0}},
	{{"Life Sciences", "Живые науки"}, {0, 0, 0, 0, 0}},
	{{"Physical Sciences", "Физические науки"}, {0, 0, 0, 0, 0}},
	{{"Social Sciences", "Социальные науки"}, {0, 0, 0, 0, 0}},
	{{"Tactics", "Тактика"}, {0, 0, 0, 0, 0}},
	{{"Technology", "Технологии"}, {0, 0, 0, 0, 0}},
	{{"Mechanics", "Механика"}, {0, 0, 1, 1, 1}},
	{{"Perception", "Акробатика"}, {1, 1, 1, 1, 1}},
