...
static struct feat_i
{
	...
	{{"Weapon focus (Advanced Melee Weapons)", "Фокус на улучшенном оружии ближнего боя"}, General, {{1, {WeaponProficiencyAdvancedMeleeWeapons}}}},
	{{"Weapon focus (Exotic Weapons)", "Фокус на экзотическом оружии"}, General, {{1, {WeaponProficiencyExoticWeapons}}}},
	{{"Weapon focus (Heavy Weapons)", "Фокус на тяжелом вооружении"}, General, {{1, {WeaponProficiencyHeavyWeapons}}}},
	{{"Weapon focus (Lightsabers)", "Фокус на световом мече"}, General, {{1, {WeaponProficiencyLightsabers}}}},
	{{"Weapon focus (Pistols)", "Фокус на пистолетах"}, General, {{1, {WeaponProficiencyPistols}}}},
	{{"Weapon focus (Rifles)", "Фокус на винтовках"}, General, {{1, {WeaponProficiencyRifles}}}},
	{{"Weapon focus (Simple Weapons)", "Фокус на простом оружии"}, General, {{1, {WeaponProficiencySimpleWeapons}}}},
